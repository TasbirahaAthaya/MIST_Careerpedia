...
<!-- Head menu search form ends -->                         
  ...
  <div class="tab-content">
    <div id="profile-tab" class="tab-pane active">
      <div class="pd-20">
<div class="vd_info tr" <?php if($ttl == "X"){echo "style=\"visibility:hidden;\"";} ?> > <form>
<button class="w3-btn w3-border-yellow w3-round-large w3-ripple w3-blue" type="submit" formaction="<?php echo $lnk; ?>" formmethod="get" value=".$pnewusername." name="offer_btn"><?php echo $ttl; ?></button></form><br /></td></div>      
