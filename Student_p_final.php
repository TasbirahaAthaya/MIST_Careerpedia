...
<!-- Head menu search form ends -->                         
      ...
      <div class="vd_container">
        <div class="vd_content clearfix">
          <div class="vd_head-section clearfix">
            <div class="vd_panel-header"> 
              <ul class="breadcrumb">
                <li><a href="#">MistCareerPedia</a> </li>
                <li><a href="#">Home</a> </li>
                <li class="active">Student Profile Pages</li>
              </ul>
              ...
              <div class="col-sm-3">
                <div class="panel widget light-widget panel-bd-top">
                  ...
                  <div class="panel-body">
                    ...
                    <h2 class="font-semibold mgbt-xs-5">Abdur Rahman</h2>
                    <h4>Student at Mist</h4>
                    <p>Hardworking,displined and professional in workplace</p>
                    <div class="mgtp-20">
  ...
  <ul class="nav nav-tabs widget">
     <li> <a data-toggle="tab" href="#projects-tab"> Home <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
    <li class="active"> <a data-toggle="tab" href="#profile-tab"> Profile <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
    <li> <a data-toggle="tab" href="#photos-tab"> Blog <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
       <li> <a data-toggle="tab" href="#photos-tab"> Post Resume<span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
      </ul>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">Abdur</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">Rahman</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">Abdur Rahman</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">Abdur123@Vgmail.com</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">Basketball, WebDesign, Android etc.</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-sm-6">
            <div class="row mgbt-xs-0">
              ...
              <div class="col-xs-7 controls">01784236751</div>
              <!-- col-sm-10 --> 
            </div>
          </div>
        </div>
 ...
 <hr class="pd-10"  />
        <div class="row">
          <div class="col-sm-7 mgbt-xs-20">
            ...
            <div class="content-list content-menu" style="overflow-y: scroll; height: 300px;">
              <ul class="list-wrapper">
                <li class="mgbt-xs-10"> <span class="menu-icon vd_green"><i class="fa  fa-circle-o"></i></span> <span class="menu-text"> 
                Intern  at Grammenphone Ltd.<span class="menu-info"><span class="menu-date"> March 2015 ~ Now</span></span> </span> </li>
                <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text">Android developer at Mc. Dondon <span class="menu-info"><span class="menu-date"> working</span></span> </span> </li>
                <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text">Web Designer at Web Design Company Ltd. <span class="menu-info"><span class="menu-date"> working</span></span> </span> </li>
          ...
          <div class="col-sm-5">
            ...
            <div class="content-list content-menu" style="overflow-y: scroll; height: 300px;">
              <ul class="list-wrapper">
                <li class="mgbt-xs-10"> <span class="menu-icon vd_green"><i class="fa  fa-circle-o"></i></span> <span class="menu-text"> Studying at MILITARY INSTITUTE OF SCIENCE AND TECHNOLOGY <a href="http://www.venmond.com/"></a> <span class="menu-info"><span class="menu-date"> From Feb 2014~ Dec 2017 </span></span> </span> </li>
                <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text"> Studies B.S.c in Computer Science and Engineering<span class="menu-info"><span class="menu-date"> From Feb 2014~ Dec 2017</span></span> </span> </li>                
                <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text"> Studied science at Rajjuk Uttora Model School and college<span class="menu-info"><span class="menu-date"> From 2011 ~ 2013 </span></span> </span> </li>
                <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text"> Studied science at 
                Rajjuk Uttora Model School and college <span class="menu-info"><span class="menu-date"> From 2000 ~ 2010</span></span> </span> </li>
...
<hr class="pd-10"  />
        <div class="row">
          <div class="col-sm-7 mgbt-xs-20">
            <h3 class="mgbt-xs-15 font-semibold"><i class="fa fa-file-text-o mgr-10 profile-icon"></i> EXTRA-CURRICULAM ACTIVITIES</h3>
            <div class="content-list content-menu" style="overflow-y: scroll; height: 300px;">
              <ul class="list-wrapper">
                <li class="mgbt-xs-10"> <span class="menu-icon vd_green"><i class="fa  fa-circle-o"></i></span> <span class="menu-text"> 
                Volunteer at Red Crescent <span class="menu-info"><span class="menu-date">Working</span></span> </span> </li>
                <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text">
                Basketball Player Sports Club <span class="menu-info"><span class="menu-date"> present player</span></span> </span> </li>
                <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text"> 
                Member at Bissho Sahitto Kendro <span class="menu-info"><span class="menu-date"> Present Member</span></span> </span> </li>
             
              </ul>
            </div>
          </div>
          <div class="col-sm-5">
            <h3 class="mgbt-xs-15 font-semibold"><i class="fa fa-trophy mgr-10 profile-icon"></i> SKILLS</h3>
            <div class="content-list content-menu" style="overflow-y: scroll; height: 300px;">
              <ul class="list-wrapper">
                <li class="mgbt-xs-10"> <span class="menu-icon vd_green"><i class="fa  fa-circle-o"></i></span> <span class="menu-text"> Web desigen <a href="http://www.venmond.com/"></a> <span class="menu-info"><span class="menu-date"> </span></span> </span> </li>
                <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text"> Android<a href="http://www.venmond.com/"></a> <span class="menu-info"><span class="menu-date"></span></span> </span> </li>                
                <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text"> Microsoft Office(word and Powepoint)<a href="http://www.venmond.com/"></a> <span class="menu-info"><span class="menu-date"> </span></span> </span> </li>
                <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text"> Java <a href="http://www.venmond.com/"></a> <span class="menu-info"><span class="menu-date"></span></span> </span> </li>
                 <li class="mgbt-xs-10"> <span class="menu-icon vd_grey"><i class=" fa  fa-circle-o"></i></span> <span class="menu-text"> C and C++ <a href="http://www.venmond.com/"></a> <span class="menu-info"><span class="menu-date"></span></span> </span> </li>
