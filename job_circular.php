    ...
    <li id="top-menu-profile" class="profile mega-li"> 
        <a href="#" class="mega-link"  data-action="click-trigger"> 
            ...
            <span class="mega-name">
                Samia <i class="fa fa-caret-down fa-fw"></i> 
            </span>
        </a> 
...
<!-- Head menu search form ends -->                         
              ...
              <div class="col-sm-12">
                <div class="panel widget light-widget">
                  ...
                  <form class="form-horizontal" action="#" role="form">
                    ...
                    <!--  <h2 class="mgbt-xs-20"> Profile: <span class="font-semibold">Samia Hassan</span> </h2> -->
                      <br/>
                      <div class="row">
  ...
  <ul class="nav nav-tabs widget">
    ...
    <li > <a data-toggle="tab" href="user-profile.php"> Profile <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
    <li> <a data-toggle="tab" href="userBlog.php"> Blog <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
	<li class="active"> <a data-toggle="tab" href="job_circular.php"> Job Circular <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
	<li> <a data-toggle="tab" href="#photos-tab"> Candidate List <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
      </ul>

                        <div class="col-sm-9">
                          <h3 class="mgbt-xs-15">Requirements</h3> 
                          <div class="form-group">
                            <label class="col-sm-3 cntrol-label">Field Of Study</label>
                          ...
                          <div class="form-group">
                            <label class="col-sm-3 control-label">Grade Point Average</label>
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="password" class="width-40"  placeholder="GPA">
                                </div>
                                <!-- col-xs-12 --> 
                              </div>
                              <!-- row --> 
                          ...
                          <div class="form-group">
                            <label class="col-sm-3 control-label">Project Experience</label>
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="password" class="width-40"  placeholder="link of Project">
                                </div>
                                <!-- col-xs-12 --> 
                              </div>
                              <!-- row --> 
                          ...
                          <div class="form-group">
                            <label class="col-sm-3 control-label">Extra-Curriculam Activity</label>
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                          ...
                          <div class="form-group">
                            <label class="col-sm-3 control-label">Previous Job Experience</label>
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
						  ...
						  <div class="form-group">
                            <label class="col-sm-3 control-label">B.Sc Completion Year</label>
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 controls">
                              <div class="row mgbt-xs-0">
                                <div class="col-xs-9">
                                  <input type="date" id="datepicker-normal" class="width-40" />
                                </div>
                                <!-- col-xs-12 -->
                                <div class="col-xs-2">
                                  <div class="btn-action">
                          ...
                          <hr/>
                          <h3 class="mgbt-xs-15">Contact List</h3>
                          <div class="form-group">
                    ...
                    <!-- panel-body -->
                    <div class="pd-20">
                      <button class="btn vd_btn vd_bg-green col-md-offset-3"><span class="menu-icon"><i class="fa fa-fw fa-check"></i></span> POST</button>
                    </div>
                  </form>
                </div>
                <!-- Panel Widget --> 
