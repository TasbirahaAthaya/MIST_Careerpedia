		...
		<input type="text" name="form-lastname" placeholder="Last Name" class="form-lastname form-control" id="form-lastname">
          ...
          <div class="field-wrap">
            ...
            <select name="table" style="height:100%; width: 100%;border-radius: 5px;padding: 10px; line-height: 100%;">
                <option value="Instructor"> <br><b>Instructor</b><br> </option>
          ...
          <?php
            if((isset($_POST["Join"])))
            {
                ...
                if($fname == "" || $lname == "")
                {
                    echo"
                    <script>
                        alert(\"Please insert both first and lastname\");location.replace(\"index.php\");
                    </script>
                    ";
                    goto loop_end1;
                }
                ...
                if($email == "")
                {
                    echo"
                    <script>
                        alert(\"Input Email\");location.replace(\"index.php\");
                    </script>
                    ";   goto loop_end1;                  
                }
                ...
                if($numofrows > 0)
                {
                    echo"
                    <script>
                        alert(\"Email already in Use\");location.replace(\"index.php\");
                    </script>
                    ";          goto loop_end1;       
                }
                $username="";
                if((isset($_POST["form-username"])))
                {
                    $username = $_POST["form-username"];
                     ...
                     echo"
                    <script>
                        alert(\"Input an username\");location.replace(\"index.php\");
                    </script>
                    ";       goto loop_end1;             
                }
                ...
                if($numofrows > 0)
                {
                    echo"
                    <script>
                        alert(\"Username in Use\");location.replace(\"index.php\");
                    </script>
                    ";          goto loop_end1;       
                }
                $pw = $_POST["form-password"];
