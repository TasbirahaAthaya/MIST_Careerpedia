...
<!--<div class="content">
  <div class="container">
   ...
   <ul class="nav nav-tabs widget">
     <li class="active"> <a data-toggle="tab" href="professor's-profile_withoutedit.php"> Profile <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
    <li> <a data-toggle="tab" href="blog-content2.php"> Blog <span class="menu-active"><i class="fa fa-caret-up"></i></span> </a></li>
       </ul>
    ...
    <div class="col-md-8">
        <div class="panel widget light-widget panel-bd-top">
              ...
              <div class="panel-body">
                ...
                <p class="vd_soft-grey">By: <a href="#">Col Humayun Writer</a></p>
                <hr/>
