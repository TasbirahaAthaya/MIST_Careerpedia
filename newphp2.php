...
<table style="width:100%">
  <caption>TA/RA Circular Best Match</caption>
  
  <tr>
    <td>1</td>
    <td><img src="img/avatar/big.jpg" alt="name" width="200" height="200" /></td>
    <td>Name: Fahim Ahmed <br /> Number of Publication : 1 <br />BSC completed from MIST at year 2015 <br />Achieved GPA 3.40 on a scale of 4.00<br /> Has 3 publications on the topic Algorithm <br /></td>
    <td><button class="button button1">View Profile</button><br /><button class="button button2">Other TA/RA</button><br /></td>
  </tr>
